...
$apiProduct = file_get_contents($root . "/app/api/controller/ProductController.php");
...
assertUpstreamSyncCompatibility(strpos($apiProduct, '$tmp = $logic->getProducts([$pid]);') !== false, "prodetail must fall back to the database when its cache cannot be rebuilt");
